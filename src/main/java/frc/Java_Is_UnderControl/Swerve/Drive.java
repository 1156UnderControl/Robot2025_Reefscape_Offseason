...
public class Drive {
  ...
  public void setSwerveBrakeMode(boolean isBrake) {
    this.frontLeftModule.setModuleBrakeMode(isBrake);
    this.frontRightModule.setModuleBrakeMode(isBrake);
    this.backLeftModule.setModuleBrakeMode(isBrake);
    this.backRightModule.setModuleBrakeMode(isBrake);
  }
}